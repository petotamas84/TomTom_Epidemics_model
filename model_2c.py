...
inf = 300.0         #starting value of infected people
...
filename = '2_model' + str(pop_k) + '_' + str(ri) + '_' + str(rate_i) + '_' + str(rate_d) + '_c' + '.png'
...
plt.subplot(412)
plt.plot(di_t, ill_t, 'mo', markersize = 5)
plt.plot(di_t, sum_ill_t, 'yo', markersize = 5)
plt.ylabel("Number of patients", fontsize = 8)

plt.subplot(413)
plt.plot(dd_t, n_death_t, 'ko', markersize = 5)
plt.plot(dd_t, death_t, 'ro', markersize = 5)
