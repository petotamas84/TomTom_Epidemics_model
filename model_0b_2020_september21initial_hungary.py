...
filename = "2020_september21_covid_hu" + str(ri) + ".txt"
f = open(filename, "w+")
...
while(inf < pop and ill >= 2):
    ...
    f.write("%d  %.3f  %.3f   %d  %.3f  %.3f   %d  %.3f  %.3f   %d  %.3f  %.3f\n"  % (d, n_inf, inf, di, ill, sum_ill, dd,  n_death, death, dr, n_rec_c, rec_c))

figure_name = '0b_model_2020_september21intial_hungary_figure' + '_' + str(ri) + '_' + str(rate_i) + '_' + str(rate_d) + '.png'
